...
export async function createSession(userId: string, request?: Request, options?: { mfaVerified?: boolean; recent?: boolean; authenticationMethod?: "PASSWORD" | "PASSWORD_TOTP" | "PASSWORD_RECOVERY" | "MAGIC_LINK" | "MFA_ENROLLMENT" }) {
