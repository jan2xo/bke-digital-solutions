import type { SecurityEventOutcome, SecurityEventSeverity, SecurityEventType } from "@/platform/host/generated/prisma/client";

type Definition = { label: string; outcome: SecurityEventOutcome; severity: SecurityEventSeverity; explanation: string };

const defaults: Definition = { label: "Security activity", outcome: "INFORMATIONAL", severity: "LOW", explanation: "An administrator security action was recorded." };
