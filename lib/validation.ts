...
export const checkoutSchema = z.object({ purchasePlanId: z.string().cuid(),customerAccountId:z.string().cuid(),offerIdentifier:z.string().trim().min(1).max(100).optional() }).strict();
