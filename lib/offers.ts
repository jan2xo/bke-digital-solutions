import "server-only";
import { Prisma, type DiscountOffer } from "@/platform/host/generated/prisma/client";
...
export async function findPublicPromotion(tx:Prisma.TransactionClient|typeof import("@/platform/host/db")["db"],plan:OfferPlanContext,now=new Date()){
