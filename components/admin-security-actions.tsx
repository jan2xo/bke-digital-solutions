...
export function AdminSecurityActions() {
  ...
  async function disable() { if (!confirm("Disable administrator email verification? Access will be blocked until you verify it again.")) return; const body = await call("/api/auth/mfa/disable"); if (body) router.replace("/security/mfa"); }
