      ...
      <fieldset className="grid gap-2 rounded-xl border border-[#2d3850] p-4">
        ...
        {allowRecipientPurchase ? (
          <label className="flex items-start gap-2">
            ...
            />
            <span><b>For someone else</b><span className="block text-sm text-[#a8b5c4]">Payment stays with your purchasing account. The license is reserved for the recipient's verified email and is not granted to you first.</span></span>
          </label>
        ) : (
