...
type Status = { id: string; provider: "PAYMONGO" | "RESEND"; environment: "TEST" | "LIVE"; enabled: boolean; senderName: string | null; senderEmail: string | null; supportEmail: string | null; validationStatus: string; lastValidationCode: string | null; lastValidatedAt: string | null; deliveryHealth: string | null; lastSuccessfulDeliveryAt: string | null; lastDeliveryFailureCategory: string | null; lastDeliveryFailureAt: string | null; credentials: { type: string; hint: string; createdAt: string }[] };
...
export function AdminProviderManager({ statuses }: { statuses: Status[] }) {
  ...
  async function send(payload: Record<string, unknown>) {
    ...
    setMessage("Provider configuration updated."); router.refresh();
  }
