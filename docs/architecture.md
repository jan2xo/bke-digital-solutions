...
Repository controls are not equivalent to production certification. Licensing
Agent runtime handoff, production scanner/signing infrastructure, backups,
VPS/HTTPS, and professional compliance reviews retain the statuses in
`TRUTHCHECK.md`.
