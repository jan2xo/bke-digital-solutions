...
vi.mock("@/platform/host/db", () => ({ db: { $queryRaw: mocks.query } }));
vi.mock("@/platform/host/env", () => ({ env: { PAYMENT_PROVIDER: "paymongo", EMAIL_PROVIDER: "resend", REDIS_URL: "redis://valkey:6379" } }));
