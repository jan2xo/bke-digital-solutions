...
const requiredPaths = [
  ...
  "prisma/migrations/0001_payments_checkout_attempt_baseline/migration.sql",
  "prisma/migrations/0002_payments_provider_event_baseline/migration.sql",
  "prisma/migrations/0003_payments_settlement_fact_baseline/migration.sql",
  "prisma/migrations/0004_payments_refund_operation_baseline/migration.sql",
  "prisma/repositories",
  "contracts",
  "logic",
