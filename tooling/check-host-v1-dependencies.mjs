...
const forbiddenRoots = ["lib", "prisma", "platform/host/generated/prisma"];
...
if (legacyFiles.length === 0) {
  console.log("V2 PRODUCTION HOST V1-FREE GREEN: no reachable root lib/, prisma/, or platform/host/generated/prisma implementation.");
  process.exit(0);
}
