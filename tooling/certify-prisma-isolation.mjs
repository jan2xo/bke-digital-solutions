...
function runCompositor(moduleName, expectedSuccess = true) {
  ...
  runProcess(
    process.execPath,
    ["platform/persistence/migration-compositor.mjs", moduleSpec.moduleId],
    expectedSuccess,
