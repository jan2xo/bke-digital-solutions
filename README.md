...
See [architecture](docs/architecture.md), [authorization matrix](docs/authorization.md), [payment flow](docs/payment-flow.md), and [threat model](docs/threat-model.md).
