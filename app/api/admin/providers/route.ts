...
import { revokeProviderCredentials, safeProviderStatuses, saveProviderConfiguration, setProviderState, validateProviderConfiguration } from "@/apps/web/providers/capability";
