...
export default async function Home() {
  ...
  return <>
    <section className="hero-section"><div className="hero-glow"/><div className="shell hero-inner"><div className="hero-product-icon" aria-hidden="true"><span className="hero-play">▶</span><span className="hero-blocks"><i/><i/><i/><i/><i/><i/><i/><i/></span></div><p className="eyebrow">BKE DIGITAL SOLUTIONS</p><h1>Your workflow, <em>backed up,</em><br/>and ready <em>to grow.</em></h1><p className="hero-copy">Secure products, flexible subscriptions, and practical software for teams that need to keep moving. Manage your work, your people, and your licenses from one dependable place.</p><div className="hero-actions"><Link className="button button-yellow" href="/products">Explore products</Link><Link className="button button-outline" href="/licensing">See how it works</Link></div><p className="hero-tagline">BUILD WITH CONFIDENCE. SHIP WITH CLARITY.</p></div></section>
